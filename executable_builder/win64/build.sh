...
# From https://github.com/cdrx/docker-pyinstaller/blob/master/entrypoint-windows.sh
...
if [[ "$@" == "" ]]; then
    pyinstaller -F --name proc_wrapper --clean -y --dist ./dist/windows --workpath /tmp proc_wrapper/__main__.py
