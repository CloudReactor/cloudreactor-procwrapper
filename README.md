...
Wraps the execution of processes so that a service API endpoint is informed
of the progress. Also implements retries, timeouts, and secret injection
from AWS into the environment.
