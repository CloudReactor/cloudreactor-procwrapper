...
To download and run the wrapper on a RHEL/Fedora/Amazon Linux 2 machine:
    ...
    RUN wget -nv https://github.com/CloudReactor/cloudreactor-procwrapper/raw/5.3.1/bin/pyinstaller/al2/5.3.1/proc_wrapper.bin
...
On a Debian based (including Ubuntu) machine:
    ...
    RUN wget -nv https://github.com/CloudReactor/cloudreactor-procwrapper/raw/5.3.1/bin/pyinstaller/debian-amd64/5.3.1/proc_wrapper.bin
    ENTRYPOINT ["proc_wrapper.bin"]
