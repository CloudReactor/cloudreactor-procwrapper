...
3.  The pull request should work for Python 3.8, 3.9, 3.10, 3.11, and 3.12. Check the build and make sure that the tests pass for all supported Python versions.
