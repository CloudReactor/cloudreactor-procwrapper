...
3.  The pull request should work for Python 3.9, 3.10, 3.11, 3.12, and 3.13. Check the build and make sure that the tests pass for all supported Python versions.
