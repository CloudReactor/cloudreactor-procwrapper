...
DEST_DIR="$BASE_DIR/bin/pyinstaller/al2023/$VERSION"

mkdir -p $DEST_DIR

IMAGE_NAME=cloudreactor-proc-wrapper-pyinstaller-al2023

docker build -f "$SCRIPT_DIR/Dockerfile-al2023" -t $IMAGE_NAME $BASE_DIR
